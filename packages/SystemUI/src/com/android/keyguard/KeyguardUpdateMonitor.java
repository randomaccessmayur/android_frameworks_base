...
public class KeyguardUpdateMonitor implements TrustManager.TrustListener, Dumpable {
    ...
    protected KeyguardUpdateMonitor(
        ...
        mBatteryStatus = new BatteryStatus(BATTERY_STATUS_UNKNOWN, 100, 0, 0, 0, true, false, false, false, false, false);
    ...
    private boolean isBatteryUpdateInteresting(BatteryStatus old, BatteryStatus current) {
        ...
        // change in smart charging while plugged in
        if (nowPluggedIn && current.smartChargeStatus != old.smartChargeStatus) {
            return true;
        }
